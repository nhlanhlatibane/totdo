...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-navbar-light" role="navigation">
		<div class="container">
			<a href="${pageContext.request.contextPath}/todo/create"
				type="button" class="btn btn-info btn-lg">New</a>
		</div>
	</nav>
	<div class="container">
						...
						<c:forEach var="todo" items="${todos}">
							<tr>
								...
								<td><a
									...
									class="btn btn-primary">Complete</a> &nbsp; <a
